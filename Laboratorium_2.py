...
# letter = ('A', 'B')  # krotka = tuple
# print(letter)
# letter.append('D')   # uwaga w krotce nie mogę zmieniać wartości, jej elementów
...
# dane_osobowe = {
#   'imię':['Ala','Ola','Tola'],
#   'nazwisko':['Kowalska','Kwiatkowska','Psorz'],
#   'wiek':['17','22','25']
# }
# id = int(input('Podaj index od 0 do 2: '))
# fname = dane_osobowe['imię'][id]
# sname = dane_osobowe['nazwisko'][id]
# wname = dane_osobowe['wiek'][id]
# print('imię {} nazwisko {} wiek {}'.format(fname, sname, wname))
...
# print(cars_countries)
# l = len(car_countries) # liczy długość, ilość elementów
# print(l)
...
del(dane_osobowe['imię'])
print(dane_osobowe)
dane_osobowe.update
dane_osobowe = {
  'imię':['Zosia','Kasia','Basia']
}